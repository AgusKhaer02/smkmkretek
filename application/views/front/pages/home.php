                                ...
                                <div class="<?= $value->foto ?>">
                                    <div class="container">
                                        <div class="banner-info-bg">
                                            ...
                                            <p class="mt-4 pr-lg-4"style="-webkit-text-stroke: 1px black;"><?= $value->deskripsi ?></p>
                ...
                ?>
                    <div class="col">
                        <div class="card shadow-sm">
							...
							<div class="my-2 ">
                            <h1><b><center><?= $value->jenis_extra ?></center></b></h1>
							</div>
                            <div class="card-body">
                ...
                ?>
                    <div class="col">
                        <div class="card shadow-sm mb-3">
                            ...
                            <h2><b><center><?= $value->nama ?></center></h2></b>
							<div class="my-2 ">
							<p><?=$value->deskripsi?></p>
							</div>
                        </div>
    ...
    <section class="w3l-videohny" id="video" style="background: url('http://i3.ytimg.com/vi/dDeyzuvF0uk/hqdefault.jpg') no-repeat center;">
        <div class="new-block py-5">
			...
			<h3 class="hny-title my-3 text-left mb-5">Video Profie</h3>
			<div class="my-2 ">
